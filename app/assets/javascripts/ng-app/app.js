function homeController($scope,$http){
	...
	// Value 1 is Other regular costing cost and value 2 is the My costing
...
//	if ($scope.personnel_my==0){
//		$scope.personnel_my = $scope.personnel_my + v["first_selection_personnel2"]
//		$scope.personnel_actual = $scope.personnel_actual + v["first_selection_personnel1"]
//	}else{
//		$scope.personnel_my = $scope.personnel_my + v["personnel2"]
//		$scope.personnel_actual = $scope.personnel_actual + v["personnel1"]
//	}